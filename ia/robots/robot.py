...
class Robot(object):
    u'''Le but est de pouvoir faire depuis n'importe quelle classe
    ...
    def copy_from(self, robot):
        u'''inconvnient de cette mthode : c'est une copie  l'instant t
        ...
        Robot._vrille = robot.__dict__[u'_vrille']
